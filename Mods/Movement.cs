...
namespace VapeMenu.Mods
{
    public class Movement
    {
            ...
            if (rightGrab || leftGrab)
            {
                if (pearl == null)
                {
                    ...
                    if (pearlmat == null)
                    {
                        ...
                        if (pearltxt == null)
                        {
                            pearltxt = LoadTextureFromResource("VapeMenu.Resources.pearl.png");
        ...
        public static void ChangePullModPower()
        {
            ...
            GetIndex("Change Pull Mod Power").overlapText = "Change Pull Mod Power <color=grey>[</color><color=purple>" + powerNames[pullPowerInt] + "</color><color=grey>]</color>";
        }
