...
namespace VapeMenu.Mods
{
    public class Safety
    {
        ...
        {
            VapeMenu.Patches.ColorPatch.nameSpoofEnabled = true;
        }

        public static void NameSpoofDisabled()
        {
            VapeMenu.Patches.ColorPatch.nameSpoofEnabled = false;
        }
        ...
        {
            VapeMenu.Patches.ColorPatch.patchEnabled = true;
        }

        public static void NoColorSpoof()
        {
            VapeMenu.Patches.ColorPatch.patchEnabled = false;
        }
    }
}
