...
namespace VapeMenu.Mods.Spammers
{
    public class Sound
    {
        ...
        public static void LoadSoundboard()
        {
            ...
            if (!Directory.Exists("VapezyyMenu/Sounds" + Subdirectory))
            {
                Directory.CreateDirectory("VapezyyMenu/Sounds" + Subdirectory);
            }
            ...
            string[] folders = Directory.GetDirectories("VapezyyMenu/Sounds" + Subdirectory);
            foreach (string folder in folders)
            {
                index++;
                int substringLength = ("VapezyyMenu/Sounds" + Subdirectory + "/").Length;
            ...
            index = 0;
            string[] files = Directory.GetFiles("VapezyyMenu/Sounds" + Subdirectory);
