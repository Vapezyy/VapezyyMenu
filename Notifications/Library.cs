...
namespace VapeMenu.Notifications
{
    ...
    public class NotifiLib : MonoBehaviour
    {
        ...
        {
            //NotifiLib.NotifiText.text = "<color=grey>[</color><color=purple>SUCCESS</color><color=grey>]</color> <color=white>Notifications cleared.</color>" + Environment.NewLine;
