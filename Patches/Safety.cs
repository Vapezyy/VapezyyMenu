    ...
    public class AntiCheat
    {
        private static bool Prefix(string susReason, string susId, string susNick)
        {
            if (AntiCheatSelf || AntiCheatAll)
            {
                ...
                {
                    NotifiLib.SendNotification("<color=grey>[</color><color=purple>ANTI-CHEAT</color><color=grey>] </color><color=white>You have been reported for " + susReason + ".</color>");
                ...
                else
                {
                    if (AntiCheatAll)
                    {
                        NotifiLib.SendNotification("<color=grey>[</color><color=purple>ANTI-CHEAT</color><color=grey>] </color><color=white>" + susNick + " was reported for " + susReason + ".</color>");
                    }
                }
            }
            if (AntiACReport)
